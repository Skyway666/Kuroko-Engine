...
// If KNET_app_log->AddLogGING_SUPPORT_ENABLED is defined, MathGeoLib utilizes logging functions
// from the kNet library.
#ifndef KNET_app_log->AddLogGING_SUPPORT_ENABLED
//#define KNET_app_log->AddLogGING_SUPPORT_ENABLED
#endif
